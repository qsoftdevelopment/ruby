...
describe "#here_now" do
  before(:each) do
    ...
    @pn = Pubnub.new(:disable_origin_manager => true, :max_retries => 0, :subscribe_key => 'demo-36', :publish_key => 'demo-36', :auth_key => :demoish_authkey, :secret_key => 'some_secret_key', :error_callback => @error_callback)
    @pn.uuid = 'rubytests'
