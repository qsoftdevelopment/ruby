      ...
      unless @left
        ...
        if app.env[:subscriptions].nil?
          ...
          @channel.each do |channel|
            Pubnub.logger.debug(:pubnub){"#{app.env[:subscriptions].get_channels.to_s}.include? #{channel}"}
          ...
          @channel_group.each do |channel_group|
            Pubnub.logger.debug(:pubnub){"#{app.env[:subscriptions].get_channel_groups.to_s}.include? #{channel_group}"}
